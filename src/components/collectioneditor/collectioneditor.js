define(['dialogHelper', 'loading', 'apphost', 'layoutManager', 'connectionManager', 'appRouter', 'globalize', 'emby-checkbox', 'emby-input', 'paper-icon-button-light', 'emby-select', 'css!assets/css/material-icons/style', 'css!components/formdialog', 'emby-button', 'css!assets/css/flexstyles'], function (dialogHelper, loading, appHost, layoutManager, connectionManager, appRouter, globalize) {
    'use strict';
