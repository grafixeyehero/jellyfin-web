define(['lazyLoader', 'imageFetcher', 'layoutManager', 'browser', 'appSettings', 'require', 'css!components/images/style'], function (lazyLoader, imageFetcher, layoutManager, browser, appSettings, require) {
    'use strict';
