define(['scroller', 'dom', 'layoutManager', 'inputManager', 'focusManager', 'browser', 'registerElement', 'css!components/emby-scroller/emby-scroller'], function (scroller, dom, layoutManager, inputManager, focusManager, browser) {
    'use strict';
