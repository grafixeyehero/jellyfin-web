define(['require', 'inputManager', 'browser', 'globalize', 'connectionManager', 'scrollHelper', 'serverNotifications', 'loading', 'datetime', 'focusManager', 'playbackManager', 'userSettings', 'imageLoader', 'events', 'layoutManager', 'itemShortcuts', 'dom', 'css!components/guide/guide.css', 'css!components/guide/programs', 'css!assets/css/material-icons/style', 'css!assets/css/scrollstyles', 'emby-button', 'paper-icon-button-light', 'emby-tabs', 'emby-scroller', 'css!assets/css/flexstyles', 'registerElement'], function (require, inputManager, browser, globalize, connectionManager, scrollHelper, serverNotifications, loading, datetime, focusManager, playbackManager, userSettings, imageLoader, events, layoutManager, itemShortcuts, dom) {
    'use strict';
