define(['dom', 'scroller', 'browser', 'layoutManager', 'focusManager', 'registerElement', 'css!components/emby-tabs/emby-tabs', 'css!assets/css/scrollstyles'], function (dom, scroller, browser, layoutManager, focusManager) {
    'use strict';
