define(['loading', 'events', 'dialogHelper', 'dom', 'layoutManager', 'scrollHelper', 'globalize', 'require', 'css!assets/css/material-icons/style', 'emby-button', 'paper-icon-button-light', 'emby-input', 'css!components/formdialog', 'css!assets/css/flexstyles'], function (loading, events, dialogHelper, dom, layoutManager, scrollHelper, globalize, require) {
    'use strict';
