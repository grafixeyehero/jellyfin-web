define(['browser', 'dom', 'layoutManager', 'keyboardnavigation', 'css!elements/emby-slider/emby-slider', 'registerElement', 'emby-input'], function (browser, dom, layoutManager, keyboardnavigation) {
    'use strict';
