define(["homescreenSettings", "dom", "globalize", "loading", "userSettings", "autoFocuser", "css!components/listview/listview"], function (HomescreenSettings, dom, globalize, loading, currentUserSettings, autoFocuser) {
    "use strict";
