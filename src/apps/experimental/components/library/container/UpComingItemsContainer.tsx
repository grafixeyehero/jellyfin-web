...
interface UpComingItemsContainerProps {
    topParentId?: string | null;
    items: BaseItemDto[];
}

interface UpcomingGroups {
    name: string;
    items: BaseItemDto[];
}

const UpComingItemsContainer: FC<UpComingItemsContainerProps> = ({ items }) => {
    const [upcomingGroups, setUpcomingGroups] = useState<UpcomingGroups[]>([]);
...
export default UpComingItemsContainer;
